  ...
  return (
    ...
    <div className="w-full flex flex-col gap-7.5">
      ...
      <form action="" className="w-full flex flex-col gap-7.5">
        ...
        <div className="w-full flex items-center gap-12.5">
          <div className="flex items-center flex-1 gap-12.5">
            <div className="flex flex-1 flex-col gap-3.75 font-medium">
              <label htmlFor="userid" className="text-[#374151]">Wrong Answer</label>
              <input type="number" name="userid" placeholder="" className="py-2.75 px-4 text-[#374151] border border-[#9CA3AF] rounded-lg outline-none" />
            </div>
            <div className="flex flex-1 flex-col gap-3.75 font-medium">
          ...
          <div className="flex items-center flex-1 gap-12.5">
            <div className="flex flex-1 flex-col gap-3.75 font-medium">
              ...
              <input type="text" name="userid" placeholder="Ex:250 Marks" className="py-2.75 px-4 text-[#374151] border border-[#9CA3AF] rounded-lg outline-none" />
            </div>
            <div className="flex flex-1 flex-col gap-3.75 font-medium">
