  ...
  return (
    <>
      <div className="flex items-center gap-5">
        <div className="text-[16px] font-bold text-[#374151]">Test created</div>
        <div className="py-2 px-2.5 flex justify-center items-center gap-2.5 border border-[#0C9D61] rounded-lg">
          <img src="/images/tick.svg" alt="" className="w-4 h-4" />
          <span className="text-[12px] font-normal text-[#0C9D61]">All 50 Questions done</span>
        </div>
      </div>
